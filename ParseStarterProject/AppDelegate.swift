...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
        ...
        let parseConfiguration = ParseClientConfiguration(block: { (ParseMutableClientConfiguration) -> Void in
            ParseMutableClientConfiguration.applicationId = "instagram2531"
            ParseMutableClientConfiguration.clientKey = "myMasterKey2531"
            ParseMutableClientConfiguration.server = "https://instagram-clone2531.herokuapp.com/parse"
        })
